...
const CustomLabel: React.FC<CustomLabelProps> = ({ color, expandable, children, ...other }) => {
  const theme = useTheme();
  const colors = {
    blue: (theme.vars || theme).palette.primary.dark,
    green: (theme.vars || theme).palette.success.dark,
  };
...
const CustomTreeItem: React.FC<CustomTreeItemProps> = React.forwardRef(
  (props, ref) => {
    ...
    const {
        ...
        label,
        disabled,
        rootRef: ref as React.Ref<HTMLLIElement>,
      });
